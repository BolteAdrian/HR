        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateApply = table.Column<DateTime>(type: "datetime", nullable: true),
                    FunctionApply = table.Column<long>(nullable: false),
                    FunctionMatch = table.Column<long>(nullable: true),
                    Observation = table.Column<string>(maxLength: 500, nullable: true),
                    Experience = table.Column<string>(maxLength: 500, nullable: true),
                    Studies = table.Column<string>(maxLength: 500, nullable: true),
                    ModeApply = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Team = table.Column<string>(unicode: false, maxLength: 200, nullable: true),
                    CompanyShortName = table.Column<string>(maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FunctionApply = table.Column<long>(nullable: true),
                    DepartamentApply = table.Column<long>(nullable: true),
                    Accepted = table.Column<bool>(nullable: true),
                    TestResult = table.Column<string>(maxLength: 200, nullable: false),
                    RefusedReason = table.Column<int>(nullable: true),
                    RefusedObservation = table.Column<string>(maxLength: 200, nullable: true),
                    Comments = table.Column<string>(maxLength: 200, nullable: true),
                    DateAnswer = table.Column<DateTime>(type: "datetime", nullable: true),
                    OfferStatus = table.Column<int>(nullable: true),
                    EmploymentDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    AddedBy = table.Column<string>(maxLength: 100, nullable: true),
                    AddedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    UpdatedBy = table.Column<string>(maxLength: 100, nullable: true),
                    UpdatedAt = table.Column<string>(maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Interviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Interview_Candidate",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterviewTeams", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InterviewTeam_Employee",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InterviewTeam_InterviewTeam",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterviewTeams_EmployeeId",
                table: "InterviewTeams",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_InterviewTeams_InterviewId",
                table: "InterviewTeams",
                column: "InterviewId");
        }
